            ...
            <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-success">
                ...
                <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                    ...
                    <div id="searchUsers" class="pt-1 ">
                        <form action="inscription.php" method="POST" id="form-search form-inline" role="search" class="form-control bg-transparent border border-0">
            ...
            <div class="boite-connexion">
                ...
                <div>
                    <form action="traitement-inscription.php" method="POST"> 
                        ...
                        <!-- Inscription en renseignant des informations complémentaires -->
                        ...
                        <label class="mb-1" for="prenom">Prénom : </label><br>
                        <input class="rounded px-1" type="text" name="prenom" id="prenom" required/><br>
                        <label class="mb-1" for="nom">Nom : </label><br>
                        <input class="rounded px-1" type="text" name="nom" id="nom" required/><br>
                        <label class="mb-1" for="password">Mot de passe : </label><br>
                        <input class="rounded px-1 s-2" type="password" name="password" id="password" required/>
                        <i class="fas fa-eye pt-2 ps-2" id="eye"></i><br><br>

                        <button type="submit" class="button mt-3 mb-3 rounded bg-white ">Envoyer</button>
