                ...
                <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="consulter.php" class="nav-link active">
                                Consulter
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div id="searchUsers" class="pt-1 ">
                        <form action="consulter.php" method="POST" id="form-search form-inline" role="search" class="form-control bg-transparent border border-0">
