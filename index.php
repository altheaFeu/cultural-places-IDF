...
<html>
    <head>
        ...
        <!-- jQuery -->
        <script defer src="js/jquery-3.6.3.min.js" type="text/javascript"></script>
        
        <script defer src="js/backToTop.js" type="text/javascript"></script>
            ...
            <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-success">
                ...
                <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                    ...
                    <div id="searchUsers" class="pt-1 ">
                        <form action="index.php" method="POST" id="form-search form-inline" role="search" class="form-control bg-transparent border border-0">
